...
SRMAP.getNiceDate = function(seconds) {
    ...
    return niceDate.getFullYear() + "-" + SRMAP.addZero(niceDate.getMonth()) + "-" + SRMAP.addZero(niceDate.getDate()) + " " + SRMAP.addZero(niceDate.getHours()) + ":" + SRMAP.addZero(niceDate.getMinutes());
};
